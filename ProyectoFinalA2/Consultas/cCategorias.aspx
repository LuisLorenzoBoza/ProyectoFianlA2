<%@ Page Title=""Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cCategorias.aspx.cs" Inherits="ProyectoFinalA2.Consultas.cCategorias" %>
        ...
        <div>
            <div class="form-group">
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col-lg-11">
                        <asp:GridView ID="CategoriaGridView" runat="server" AllowPaging="true" PageSize="7" CssClass="table table-striped table-hover table-responsive-lg" AutoGenerateColumns="False" OnSelectedIndexChanged="CategoriaGridView_SelectedIndexChanged">
